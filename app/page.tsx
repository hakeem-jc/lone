    ...
    <main className="bg-gray-900 text-white min-h-screen">
      ...
      <section className="flex flex-col lg:flex-row px-4 lg:px-12 py-10 min-h-screen">
        ...
        <div className="flex lg:w-1/2">
          <img src="/fintech.png" alt="mockup" className="w-full h-auto object-contain" />
        </div>
      </section>

      <section className="flex justify-center items-center min-h-screen py-10 lg:py-20 px-4">
        <div className="text-center w-full max-w-4xl">
          <h1 className="text-center text-3xl lg:text-5xl font-semibold mb-6 lg:mb-10">
          ...
          <div className="p-4 lg:p-8 mx-auto text-left">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse mb-6">
                <tbody>
                  {[
                    ["Apply in Minutes:", "Our streamlined application process takes just a few taps. No paperwork, no waiting in lines."],
                    ["Instant Decision:", "Our advanced AI evaluates your application in real-time, providing an immediate lending decision."],
                    ["Fast Funding:", "Once approved, get up to $5,000 deposited directly into your bank account within minutes."],
                    ["Flexible Repayment:", "Choose a repayment term that works for you, from 1 to 3 months."],
                    ["Transparent Pricing:", "We believe in full disclosure. Our competitive rates are clearly displayed, and we never charge hidden fees."],
                    ["Secure and Confidential:", "Your financial data is protected with bank-level encryption, ensuring your privacy and security."]
                  ].map(([title, description], index, array) => (
                    <tr key={index} className={index !== array.length - 1 ? "border-b border-gray-700" : ""}>
          ...
          <a
            href="#"
            className="inline-flex items-center justify-center px-6 py-3 lg:px-8 lg:py-4 text-base font-medium text-center border rounded-lg focus:ring-4 text-white border-gray-700 bg-sky-500 hover:bg-blue-500 focus:ring-gray-800 mt-6"
          >
            Apply Now
          </a>
        </div>
