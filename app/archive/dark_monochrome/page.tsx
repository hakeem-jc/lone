...
// ── Design tokens ────────────────────────────────────────────────────────────
const BG      = "var(--background)"; // page background
const FG      = "var(--foreground)"; // card / surface
const BORDER  = "#2d2d2d";           // subtle border
const MUTED   = "#9b9b9b";           // muted text
const DIM     = "#313131";           // dim surface / inactive states
const TEXT    = "var(--text)";
      ...
      <section className="max-w-7xl mx-auto px-6 pt-20 pb-16 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h1 className="text-5xl font-black leading-tight tracking-tight mb-6 text-white">
            ...
            <span style={{ color: TEXT, opacity: 0.5 }}>need them most.</span>
          </h1>
          ...
          <Card>
            <div className="flex items-center justify-between mb-4">
              ...
              <span
                ...
                style={{ background: DIM, color: TEXT }}
              >
                Instant Decision
              </span>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-start max-w-5xl mx-auto">
            ...
            <div className="space-y-4">
              {/* Monthly hero */}
              <div className="rounded-2xl p-6" style={{ background: TEXT, color: BG }}>
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-lg flex items-center justify-center text-xs font-bold" style={{ background: FG, color: TEXT }}>
                        1st
                      </div>
                      <div>
